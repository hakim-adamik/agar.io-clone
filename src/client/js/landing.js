...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function redirectToGame(arenaType = 'PAID') {
        ...
        // Mark game entry for post-game modal
        if (window.PostGameModal) {
            window.PostGameModal.markGameEntry(arenaType);
        }
    ...
    // Make redirectToGame available globally for post-game modal
    window.redirectToGame = redirectToGame;
    window.showPaidArenaSignupPrompt = showPaidArenaSignupPrompt;
